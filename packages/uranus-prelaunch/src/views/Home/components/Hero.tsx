...
import { Flex, Link, Text, useMatchBreakpoints } from 'uranus-uikit'
    ...
    <>
      ...
      <HeroContainer position="relative" justifyContent="center" id="homepage-hero" minHeight="358px">
        <Flex flex="1" flexDirection="column" maxWidth="512px" mt={["40px", "40px", "40px", "80px"]}>
          <StyledBigHeading>Very, Very Simple DeFi Trading for All<Badge>
            Launching Soon<img style={{ width: 11, height: 11, transform: 'translate(2px, -2px)' }} src="/images/home/landing-page/vector.png" alt=""></img>
            <img style={{ width: 11, height: 11, transform: 'translate(-1px, 4px)' }} src="/images/home/landing-page/vector.png" alt=""></img>
          </Badge></StyledBigHeading>
          ...
          <Text {...titleStyleProps} color="white">
            <Link color="rgb(70, 161, 194)" mr="5px" href="https://medium.com/uranus-finance/uranus-finance-very-very-simple-defi-for-everyone-8c864be68b6a" display="inline-block" {...titleStyleProps}>
              Learn more
            </Link>
            about URANUS Finance.
          </Text>
          <LaunchCountDown />
          {/* <img
