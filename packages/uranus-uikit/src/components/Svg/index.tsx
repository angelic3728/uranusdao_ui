...
export { default as AnalyticsFillIcon } from "./Icons/AnalyticsFill";
...
export { default as CroIcon } from "./Icons/Cro";
...
export { default as TanDiamond } from "./Icons/TanDiamond";
