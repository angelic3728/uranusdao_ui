...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://uranus.finance/images/tokens/${token.address[28]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://uranus.finance/images/tokens/${token.address[28]}.svg`;
        const secondarySrc = `https://uranus.finance/images/tokens/${tokens[randomTokenIndex].address[28]}.svg`;
