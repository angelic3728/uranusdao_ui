...
import TanPrice from "../../components/TanPrice/TanPrice";
...
const Menu: React.FC<NavProps> = ({
  ...
  const TooltipComponent = () => (
    <>
      ...
      <Text mb="16px">{t("Welcome! You are a pioneer in the TAN mines! In this mode, APR calculation, analytics, and USD values will not be shown during the initial launch week as prices and historical data points are still forming.")}</Text>
      <Text>
    ...
    <Wrapper>
      <StyledNav showMenu={false}>
        ...
        <Flex alignItems="center">
          ...
          {!isMobile && !!showTanPrice && !isBlindMode && (
            <Box mr="12px">
              <TanPrice tanPriceUsd={tanPriceUsd} tanAddress={tanAddress} iconCallback={iconCallback} />
            </Box>
          )}
          {/* <Box mt="4px">
            <LangSelector
      ...
      <BodyWrapper>
        <Inner isPushed={false} showMenu={showMenu}>
          ...
          {/* <Footer
            ...
            setLang={setLang}
            currentLang={currentLang}
            tanPriceUsd={tanPriceUsd}
            buyTanLabel={buyTanLabel}
