...
export interface VaultUser {
  isLoading: boolean
  userShares: string
  tanAtLastUserAction: string
  lastDepositedTime: string
  lastUserActionTime: string
}
export interface TanVault {
  totalShares?: string
  pricePerFullShare?: string
  totalTanInVault?: string
  estimatedTanBountyReward?: string
  totalPendingTanHarvest?: string
  fees?: VaultFees
  userData?: VaultUser
}
