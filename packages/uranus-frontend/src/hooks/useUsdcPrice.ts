import { ChainId, Currency, currencyEquals, JSBI, Price } from 'uranus-swap-sdk'
...
export const useTanUsdcPrice = (): Price | undefined => {
  const tanUsdcPrice = useUsdcPrice(tokens.tan)
  return tanUsdcPrice
}
