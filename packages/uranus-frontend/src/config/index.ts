...
export const TAN_PER_BLOCK = Number(process.env.REACT_APP_TAN_PER_BLOCK) // FIXME tan per block
export const BLOCKS_PER_YEAR = (60 / CRONOS_BLOCK_TIME) * 60 * 24 * 365 // 10512000
export const TAN_PER_YEAR = TAN_PER_BLOCK * BLOCKS_PER_YEAR // FIXME tan block per year
