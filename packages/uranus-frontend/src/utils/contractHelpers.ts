...
import tanAbi from 'config/abi/tan.json'
...
export const getSouschefContract = (id: number, signer?: ethers.Signer | ethers.providers.Provider) => {
  ...
  const abi = config.poolCategory === PoolCategory.BINANCE ? sousChefCro : sousChef
...
export const getTanContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(tanAbi, tokens.tan.address, signer)
}
...
export const getTanVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(TanVaultAbi, getTanVaultAddress(), signer)
}
