...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from 'uranus-swap-sdk'
...
// show tanPrice
export function showTanPrice(): boolean {
  return process.env.REACT_APP_SHOW_TAN_PRICE === 'true'
}
