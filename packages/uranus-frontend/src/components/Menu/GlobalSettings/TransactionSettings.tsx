...
import { Text, Button, Input, Flex, Box } from 'uranus-uikit'
...
const ButtonStyles: CSSProperties = { borderRadius: 20 }
const InputStyles: CSSProperties = { borderWidth: 1, fontSize: 14, textAlign: 'center' }
