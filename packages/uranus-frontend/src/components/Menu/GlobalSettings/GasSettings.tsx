...
import { Flex, Button, Text } from 'uranus-uikit'
  ...
  return (
    <Flex flexDirection="column">
      <Flex mb="12px" alignItems="center">
        ...
        <QuestionHelper
          text={t(
            'Adjusts the default gas price (transaction fee) for your transaction. Higher GWEI results in faster transactions but also higher fees',
          )}
          placement="top-start"
          ml="4px"
          mt="4px"
