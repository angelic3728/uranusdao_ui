...
import { Text, PancakeToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from 'uranus-uikit'
import {
  useAudioModeManager,
      ...
      <ScrollableContainer>
        ...
        <Flex justifyContent="space-between" alignItems="center" mb="24px" pb={["20px", "20px", "20px", 0]}>
          <Flex alignItems="center">
            ...
            <QuestionHelper
              text={t('Cling! Cling! Cling! an immersive sound as our miners seek the highest clarity gems in the URANUS mines')}
              placement="top-start"
              ml="4px"
            />
          </Flex>
