...
import { Box, Flex, Text, Input, CheckmarkIcon, PencilIcon, IconButton } from 'uranus-uikit'
  ...
  return (
    <RoiCardWrapper>
      <RoiCardInner>
        ...
        <Flex justifyContent="space-between" height="36px">
          {mode === CalculatorMode.PRINCIPAL_BASED_ON_ROI ? (
            ...
            <>
              <RoiDisplayContainer onClick={onEnterEditing}>
                ...
                <RoiDollarAmount fontSize="28px" bold fadeOut={roiUSD > TRILLION}>
        ...
        <Text fontSize="16px" color="textSubtle" mt="10px">
