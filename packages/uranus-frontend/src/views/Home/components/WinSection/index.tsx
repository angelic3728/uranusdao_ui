...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from 'uranus-uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'TAN card' },
    { src: 'green', alt: 'Green TAN card with up arrow' },
    { src: 'red', alt: 'Red TAN card with down arrow' },
    { src: 'top-right', alt: 'TAN card' },
  ],
}
