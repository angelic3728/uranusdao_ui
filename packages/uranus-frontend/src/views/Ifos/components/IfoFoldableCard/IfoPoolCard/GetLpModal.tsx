...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from 'uranus-uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need TAN-CRO LP tokens to participate in the IFO!')}</Text>
