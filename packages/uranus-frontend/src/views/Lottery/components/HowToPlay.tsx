...
import { Box, Flex, Text, Heading, useMatchBreakpoints, Link, Image } from 'uranus-uikit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.tan.finance/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.tan.finance/products/lottery/lottery-guide">
