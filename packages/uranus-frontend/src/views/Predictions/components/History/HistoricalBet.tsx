...
import { Box, ChevronDownIcon, ChevronUpIcon, Flex, IconButton, PlayCircleOutlineIcon, Text, WaitIcon } from 'uranus-uikit'
...
import { formatCro, getNetPayout } from './helpers'
    ...
    return (
      <>
        ...
        <Text bold color={resultTextColor} lineHeight={1}>
          {roundResult === Result.CANCELED ? t('Canceled') : `${resultTextPrefix}${formatCro(payout)}`}
        </Text>
      </>
    )
  }
