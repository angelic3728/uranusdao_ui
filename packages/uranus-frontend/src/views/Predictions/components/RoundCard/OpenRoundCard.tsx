...
import { Card, CardBody, PlayCircleOutlineIcon, Button, useTooltip, ArrowUpIcon, ArrowDownIcon } from 'uranus-uikit'
...
const OpenRoundCard: React.FC<OpenRoundCardProps> = ({
  ...
  const { targetRef, tooltipVisible, tooltip } = useTooltip(
    <div style={{ whiteSpace: 'nowrap' }}>{`${formatCrov2(betAmount)} CRO`}</div>,
    { placement: 'top' },
  )
