              ...
              <CardBody>
                ...
                {account && (
                  <Flex alignItems="center" mb="8px">
                    ...
                    <LinkExternal href={getExplorerLink(account, 'address')}>{truncateHash(account)}</LinkExternal>
                  </Flex>
                )}
                <Flex alignItems="center" mb="16px">
                  ...
                  <LinkExternal href={getExplorerLink(snapshot, 'block')}>{snapshot}</LinkExternal>
                </Flex>
                {account ? (
                  <>
                    <Button
