...
import { Button, useModal, IconButton, AddIcon, MinusIcon, Skeleton, useTooltip, Flex, Text } from 'uranus-uikit'
...
import VaultStakeModal from '../../TanVaultCard/VaultStakeModal'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({ pool, userDataLoaded }) => {
  ...
  const stakedAutoDollarValue = getBalanceNumber(tanAsBigNumber.multipliedBy(stakingTokenPrice), stakingToken.decimals)
  ...
  const [onPresentVaultUnstake] = useModal(<VaultStakeModal stakingMax={tanAsBigNumber} pool={pool} isRemovingStake />)
        ...
        <ActionContent>
          <Flex flex="1" pt="16px" flexDirection="column" alignSelf="flex-start">
            <Balance
              ...
              fontSize="20px"
              decimals={5}
              value={isAutoVault ? tanAsNumberBalance : stakedTokenBalance}
            />
