...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useMatchBreakpoints } from 'uranus-uikit'
...
const AutoEarningsCell: React.FC<AutoEarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  const labelText = t('Recent TAN profit')
  const earningTokenBalance = autoTanToDisplay
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoTanToDisplay} decimals={3} bold unit=" TAN" />
