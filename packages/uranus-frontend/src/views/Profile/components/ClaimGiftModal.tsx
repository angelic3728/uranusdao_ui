...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from 'uranus-uikit'
  ...
  return (
    <Modal title={t('Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        ...
        <Text as="p">{t('To make it up to you, we’ll refund you the full 4 TAN it cost to make your bunny.')}</Text>
        <Text as="p" mb="8px">
