...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from 'uranus-uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% TAN', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
