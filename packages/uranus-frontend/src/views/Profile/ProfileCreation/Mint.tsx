...
import { Card, CardBody, Heading, Text } from 'uranus-uikit'
import { useWeb3React } from '@web3-react/core'
import { useTranslation } from 'contexts/Localization'
import useApproveConfirmTransaction from 'hooks/useApproveConfirmTransaction'
import { useTan, useBunnyFactory } from 'hooks/useContract'
import { Nft } from 'config/constants/nfts/types'
import { FetchStatus, useGetTanBalance } from 'hooks/useTokenBalance'
...
const Mint: React.FC = () => {
  ...
  const { balance: cakeBalance, fetchStatus } = useGetTanBalance()
