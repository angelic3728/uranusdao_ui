...
interface LeaderboardRowProps {
  bidder: Bidder
  vvsPriceUsdc: BigNumber
  isMobile: boolean
}

const LeaderboardRow: React.FC<LeaderboardRowProps> = ({ bidder, vvsPriceUsdc, isMobile }) => {
    ...
    <Box>
      <LeaderboardContainer>
        ...
        {bidders.slice(0, visibleBidders).map((bidder) => (
          <LeaderboardRow key={bidder.account} bidder={bidder} vvsPriceUsdc={vvsPriceUsdc} isMobile={isMobile} />
        ))}
      </LeaderboardContainer>
