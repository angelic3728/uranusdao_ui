...
import { Flex, Text, Button, Modal, LinkExternal, CalculateIcon, IconButton } from 'uranus-uikit'
...
const DepositModal: React.FC<DepositModalProps> = ({
  ...
  const interestBreakdown = getInterestBreakdown({
    ...
    apr,
    earningTokenPrice: vvsPrice.toNumber(),
  })

  const annualRoi = vvsPrice.times(interestBreakdown[3])
