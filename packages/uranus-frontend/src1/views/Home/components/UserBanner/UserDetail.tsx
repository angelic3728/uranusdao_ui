...
import { NoProfileAvatarIcon, Flex, Heading, Skeleton, Text, Box } from 'uranus-uikit'
...
const StyledNoProfileAvatarIcon = styled.div`
  height: 100%;
  width: 100%;
  background: linear-gradient(180deg, #5ABEB4 0%, #FEBD59 70.55%);
  border-radius: 50%;
`
...
const UserDetail = () => {
  ...
  return (
    <>
      <Desktop>
        <Box mr="24px">
          <Sticker>{profile ? <ProfileAvatarWithTeam profile={profile} /> : <StyledNoProfileAvatarIcon><img src="/images/home/landing-page/moleAvatar.png" alt="mole avatar" /></StyledNoProfileAvatarIcon>}</Sticker>
        </Box>
        <Flex flexDirection="column">
          ...
          {isLoading || !account ? (
            ...
            <Text fontSize="16px" bold color="white" width={['100%', null, null, '160px']}>
              {' '}
