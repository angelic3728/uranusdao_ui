...
import { Button, Text, Link, Flex, Checkbox, Message } from 'uranus-uikit'
          ...
          <Message variant="danger">
            <Flex flexDirection="column">
              ...
              <Text bold color={theme.colors.failure} mb="16px">
                {typeof 'If you purchase any arbitrary token, you may be unable to sell it back. Purchase knowing the risks.'}
              </Text>
